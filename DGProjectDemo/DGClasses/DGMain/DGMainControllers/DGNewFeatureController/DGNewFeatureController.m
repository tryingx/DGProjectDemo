...
@interface DGNewFeatureController () <UIScrollViewDelegate>

@property (nonatomic, weak) UIPageControl *pageControl;

@end

@implementation DGNewFeatureController
...
- (void)viewDidLoad {
    ...
    pageControl.currentPageIndicatorTintColor = DGColorWithRGB(253, 98, 42);
    pageControl.pageIndicatorTintColor = DGColorWithRGB(189, 189, 189);
...
- (void)startClick
{
    ...
    window.rootViewController = [[DGMainViewController alloc] init];
